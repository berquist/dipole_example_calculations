...
def calc_center_of_electronic_charge_pyquante(D, mol_basis):
    ...
    zerovec = np.zeros(3)
    dipole_at_zerovec = electronic_dipole_contribution_pyquante(D, mol_basis, zerovec)
    S = makeS(mol_basis)
...
def electronic_dipole_contribution_pyquante(D, mol_basis, origin_in_bohrs):
...
def calculate_dipole_pyquante(nuccoords, nuccharges, origin, D, mol_basis, do_print=False):
    assert origin.shape == (3,)
    nuclear_components_au = nuclear_dipole_contribution(nuccoords, nuccharges, origin)
    electronic_components_au = electronic_dipole_contribution_pyquante(D, mol_basis, origin)
...
def calculate_origin_pyquante(origin_string, nuccoords, nuccharges, D, mol_basis, do_print=False):
